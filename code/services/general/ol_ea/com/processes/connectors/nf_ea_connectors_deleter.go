...
//from ea_interop_service_source.b_code.i_dual_objects.collections.i_dual_connector_collection import IDualConnectorCollection
...
//
//supplier_element = \
//i_dual_repository.get_element_by_id(
//element_id=supplier_id)
//
//if isinstance(supplier_element, IDualElement):
...
//connector_ea_guid: str) \
//-> int:
//for index in range(i_dual_connector_collection.count):
//connector_at_index = \
//i_dual_connector_collection.get_at(
//index)
//
//if connector_at_index.connector_guid == connector_ea_guid:
//return \
//index
//
//return \
