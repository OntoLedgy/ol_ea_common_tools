...
//
//if not isinstance(to_element, IDualElement):
//raise \
//TypeError
//
//for connector_tuple in connectors_to_move.itertuples():
...
//-> DataFrame:
//ea_connectors = \
//ea_tools_session_manager.nf_ea_com_endpoint_manager.nf_ea_com_universe_manager.get_ea_connectors(
//ea_repository=ea_repository)
//
...
//
//typed_ea_connectors = \
//ea_connectors.loc[ea_connectors[ea_connector_type_column_name] == connector_type]
//
...
//
//from_nf_uuid = \
//__get_nf_uuid_from_ea_guid(
//ea_tools_session_manager=ea_tools_session_manager,
//ea_repository=ea_repository,
//ea_guid=from_guid)
//
//connectors_to_move = \
//typed_ea_connectors.loc[typed_ea_connectors[connector_end_column_name] == from_nf_uuid]
//
//if single_other_end_guid == DEFAULT_NULL_VALUE:
//return \
//connectors_to_move
//
//if direction == 'Incoming':
...
//
//connectors_to_move = \
//connectors_to_move.loc[connectors_to_move[connector_end_column_name] == other_nf_uuid]
//
//return \
//connectors_to_move
//
...
//ea_guid: str):
//ea_classifiers = \
//ea_tools_session_manager.nf_ea_com_endpoint_manager.nf_ea_com_universe_manager.get_ea_classifiers(
//ea_repository=ea_repository)
//
//ea_guid_column_name = \
...
//
//from_ea_classifier = \
//ea_classifiers.loc[ea_classifiers[ea_guid_column_name] == ea_guid]
//
//nf_uuids_column_name = \
//NfColumnTypes.NF_UUIDS.column_name
//
//from_ea_classifier_nf_uuid = \
//from_ea_classifier.iloc[0][nf_uuids_column_name]
//
//return \
//from_ea_classifier_nf_uuid
//
...
//
//if not isinstance(i_dual_connector, IDualConnector):
//raise \
//TypeError
//
//if direction == 'Incoming':
