...
//ea_dependencies = \
//ea_connectors.loc[
//ea_connectors[NfEaComColumnTypes.CONNECTORS_ELEMENT_TYPE_NAME.column_name] == EaConnectorTypes.DEPENDENCY.type_name]
//
//ea_dependencies = \
...
//merge_suffixes=['_generalisation', '_dependency'],
//foreign_key_dataframe=ea_dependencies,
//foreign_key_dataframe_fk_columns=['provider'],
...
//
//ea_full_dependencies = \
//ea_full_dependencies.loc[ea_full_dependencies['dependent'] != DEFAULT_NULL_VALUE]
//
//ea_full_dependencies = \
