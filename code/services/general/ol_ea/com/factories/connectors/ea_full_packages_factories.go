...
//
//while next_level.shape[0] > ea_full_packages.shape[0]:
//ea_full_packages = \
//next_level
//
//next_level = \
...
//
//next_level = \
//next_level.loc[next_level['child'] != DEFAULT_NULL_VALUE]
//
//next_level = \
//concat(
//[
