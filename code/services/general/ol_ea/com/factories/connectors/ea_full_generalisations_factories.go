...
//ea_connectors.loc[
//ea_connectors[NfEaComColumnTypes.CONNECTORS_ELEMENT_TYPE_NAME.column_name] == EaConnectorTypes.GENERALIZATION.type_name]
//
//ea_full_generalisations = \
...
//
//while next_level.shape[0] > ea_full_generalisations.shape[0]:
//ea_full_generalisations = \
//next_level
//
//next_level = \
...
//master_dataframe_key_columns=['specialisation'],
//merge_suffixes=[DEFAULT_MASTER_TABLE_SUFFIX, DEFAULT_FOREIGN_TABLE_SUFFIX],
//foreign_key_dataframe=ea_full_generalisations,
//foreign_key_dataframe_fk_columns=['generalisation'],
//foreign_key_dataframe_other_column_rename_dictionary={'specialisation': 'next_level_specialisation'})
//
//next_level = \
//dataframe_filter_and_rename(
...
//
//next_level = \
//next_level.loc[next_level['specialisation'] != DEFAULT_NULL_VALUE]
//
//next_level = \
//concat(
//[
