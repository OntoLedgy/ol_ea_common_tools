...
//
//master_dataframe_with_list_items = \
//left_merge_dataframes(
//master_dataframe=master_dataframe,
//master_dataframe_key_columns=[nf_uuids_column_name],
//merge_suffixes=['_master', '_foreign'],
...
//
//nf_uuids_with_list = \
//master_dataframe_with_list_items.groupby(nf_uuids_column_name)[master_dataframe_new_column_name].apply(list)
//
//nf_uuids_with_list = \
//nf_uuids_with_list.reset_index()
//
//nf_uuids_with_list[master_dataframe_new_column_name] = \
//nf_uuids_with_list[master_dataframe_new_column_name].apply(
//lambda nf_uuids_list:
//[]
//if nf_uuids_list == [numpy.nan]
//else nf_uuids_list)
//
//master_dataframe = \
//left_merge_dataframes(
...
//master_dataframe_new_column_name: str) \
//-> DataFrame:
//master_dataframe[master_dataframe_new_column_name] = \
//numpy.nan
//
//master_dataframe[master_dataframe_new_column_name] = \
//master_dataframe[master_dataframe_new_column_name].apply(
//lambda nf_uuids_list:
//[]
//if nf_uuids_list == numpy.nan
//else [])
