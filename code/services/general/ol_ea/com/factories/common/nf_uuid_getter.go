...
//thin_ea_explicit_objects.loc[thin_ea_explicit_objects[object_guid_column_name] == ea_guid]
//
//if thin_ea_explicit_object.shape[0] == 0:
//return \
//''
//
//nf_uuid = \
//thin_ea_explicit_object.iloc[0][nf_uuids_column_name]
//
//return \
//nf_uuid
