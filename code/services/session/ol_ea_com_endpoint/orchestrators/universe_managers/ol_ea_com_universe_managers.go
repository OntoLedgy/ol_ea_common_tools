...
import (
	...
	"github.com/OntoLedgy/ol_ea_common_tools/code/services/session/ol_ea_com_endpoint/orchestrators"
	session_orchestrators "github.com/OntoLedgy/ol_ea_common_tools/code/services/session/orchestrators"
	//"github.com/OntoLedgy/storage_interop_services/code/services/in_memory/maps"
)
...
//def __init__(
//self,
func (olEaComUniverseManagers *OlEaComUniverseManagers) Initialise(
	//ea_tools_session_manager):
	eaToolSessionmanager session_orchestrators.EaToolsSessionManagers) {

	//NfManagers.__init__(
	//self)
	olEaComUniverseManagers.OlManagers.Initialise()
...
func (olEaComUniverseManagers *OlEaComUniverseManagers) InitialiseEmptyOlEaComUniverse(
	...
	OlEaComUniverse :=
		...
		olEaComUniverseManagers.GetOlEaComUniverse(
			//ea_repository=ea_repository)
			eaRepository)

	//nf_ea_com_universe.nf_ea_com_registry.initialise_empty_nf_ea_com_universe()
	OlEaComUniverse.OlEaComRegistries.InitialiseEmptyOlEaComUniverse()
...
//self, ea_repository: EaRepositories) \
//-> DataFrame:
//nf_ea_com_universe = \
//self.__get_nf_ea_com_universe(
//ea_repository=ea_repository)
...
//nf_ea_com_universe.nf_ea_com_registry.get_ea_full_generalisations_of_type(
...
//nf_ea_com_universe.nf_ea_com_registry.get_ea_full_dependencies_of_type(
//type_ea_guid=type_ea_guid,
//table_name=table_name)
//
//return \
...
//nf_ea_com_universe.nf_ea_com_registry.get_ea_full_dependencies_of_list_of_types(
...
//nf_ea_com_universe.nf_ea_com_registry.get_intersection_and_symmetric_difference(
...
//nf_ea_com_universe.nf_ea_com_registry.get_stereotype_instances(
...
//
//relative_complement = \
//nf_ea_com_universe.nf_ea_com_registry.get_relative_complement(
...
//
//table_sub_types = \
//nf_ea_com_universe.nf_ea_com_registry.get_table_sub_types(
//table=table,
...
//nf_ea_com_universe.nf_ea_com_registry.get_ea_stereotypes_of_group(
...
//nf_ea_com_universe.nf_ea_com_registry.get_stereotyped_objects_of_group(
//stereotype_group_name=stereotype_group_name,
//table_name=table_name)
//
//return \
...
//for ea_repository, nf_ea_com_universe in self.nf_ea_com_universe_dictionary.items():
...
//ea_repository: EaRepositories) \
//-> NfEaComUniverses:
//if ea_repository in self.nf_ea_com_universe_dictionary:
//return \
//self.nf_ea_com_universe_dictionary[ea_repository]
//
//nf_ea_com_universe = \
//self.__create_nf_ea_com_universe(
//ea_repository=ea_repository)
//
//self.nf_ea_com_universe_dictionary[ea_repository] = \
//nf_ea_com_universe
...
//self,
func (olEaComUniverseManagers *OlEaComUniverseManagers) GetOlEaComUniverse(
	//ea_repository: EaRepositories) \
	eaRepository *objects.EaRepositories) *com.OlEaComUniverses { //-> NfEaComUniverses:

	olEaComUniverse :=
		&com.OlEaComUniverses{}
